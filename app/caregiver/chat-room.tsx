    ...
    >
      ...
      <View style={styles.inputArea}>
        <Pressable onPress={pickImageAndSend} style={styles.photoBtn} disabled={uploading}>
          <View style={[styles.iconCircle, { backgroundColor: "#EEE", borderColor: '#CCC', borderWidth: 1 }]}>
            {uploading ? <ActivityIndicator size="small" color="#999" /> : <Ionicons name="camera" size={22} color="#666" />}
          </View>
        </Pressable>
        ...
        <Pressable 
          onPress={sendMessage} 
          style={({ pressed }) => [styles.sendBtn, !inputText.trim() && { opacity: 0.5 }, pressed && { opacity: 0.7 }]}
...
const styles = StyleSheet.create({
  ...
  myBubble: { backgroundColor: "#9999E5", borderTopLeftRadius: 16, borderTopRightRadius: 4, borderBottomLeftRadius: 16, borderBottomRightRadius: 16 },
  otherBubble: { backgroundColor: "#F2F2F7", borderTopLeftRadius: 4, borderTopRightRadius: 16, borderBottomLeftRadius: 16, borderBottomRightRadius: 16 },
  ...
  input: { flex: 1, backgroundColor: '#F2F2F7', borderRadius: 20, paddingHorizontal: 15, paddingVertical: Platform.OS === 'ios' ? 10 : 8, minHeight: 40, maxHeight: 100, fontSize: 16 },
